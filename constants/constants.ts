...
export const CHECK_IF_IS_BURNED = retrieveEnvVariable('CHECK_IF_IS_BURNED', logger);
export const CHECK_IF_IS_LOCKED = retrieveEnvVariable('CHECK_IF_IS_LOCKED', logger);
export const TRY_COUNT_FOR_BURNED_AND_LOCKED_CHECK = retrieveEnvVariable('TRY_COUNT_FOR_BURNED_AND_LOCKED_CHECK', logger);
export const WAIT_TIME_FOR_EACH_BURNED_AND_LOCKED_CHECK = retrieveEnvVariable('WAIT_TIME_FOR_EACH_BURNED_AND_LOCKED_CHECK', logger);
